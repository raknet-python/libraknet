...
unsigned short DirectoryDeltaTransfer::DownloadFromSubdirectory(
  ...
  unsigned short setId =
      fileListTransfer->SetupReceive(transferCallback, true, host);
...
unsigned short DirectoryDeltaTransfer::DownloadFromSubdirectory(
  ...
  localFiles.AddFilesFromDirectory(
      prependAppDirToOutputSubdir ? applicationDirectory : nullptr,
      outputSubdir,
      true,
      false,
      true,
