...
class RAK_DLL_EXPORT RelayPlugin : public PluginInterface2 {
 public:
  ...
  RelayPluginEnums AddParticipantOnServer(
      const RakString& key,
 ...
 protected:
  ...
  RelayPlugin::RP_Group* JoinGroup(
      RP_Group* room,
  ...
  DataStructures::
      Hash<RakString, StrAndGuidAndRoom*, 8096, RakNet::RakString::ToInteger>
          strToGuidHash;
  DataStructures::
      Hash<RakNetGUID, StrAndGuidAndRoom*, 8096, RakNet::RakNetGUID::ToUint32>
          guidToStrHash;
