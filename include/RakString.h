...
class RAK_DLL_EXPORT RakString {
 public:
  ...
  static RakNet::RakString FormatForPOST(
      const char* uri,
      const char* contentType,
      const char* body,
      const char* extraHeaders = "");
  static RakNet::RakString FormatForPUT(
      const char* uri,
      const char* contentType,
      const char* body,
      const char* extraHeaders = "");
  ...
  /// \return Formatted string
  static RakNet::RakString FormatForGET(
      const char* uri,
      const char* extraHeaders = "");
  ...
  /// \return Formatted string
  static RakNet::RakString FormatForDELETE(
      const char* uri,
      const char* extraHeaders = "");
  ...
  static void SerializeCompressed(
      const char* str,
      BitStream* bs,
      uint8_t languageId = 0,
  ...
  static bool
  DeserializeCompressed(char* str, BitStream* bs, bool readLanguageId = false);
...
const RakNet::RakString RAK_DLL_EXPORT
