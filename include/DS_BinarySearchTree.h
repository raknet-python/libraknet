...
class RAK_DLL_EXPORT BinarySearchTree {
 public:
  ...
  node*
  Add(const BinarySearchTreeType& input, const char* file, unsigned int line);
  node*
  Del(const BinarySearchTreeType& input, const char* file, unsigned int line);
...
template <class BinarySearchTreeType>
void AVLBalancedBinarySearchTree<BinarySearchTreeType>::Add(
...
template <class BinarySearchTreeType>
void AVLBalancedBinarySearchTree<BinarySearchTreeType>::Del(
    const BinarySearchTreeType& input) {
  typename BinarySearchTree<BinarySearchTreeType>::node* current =
...
void AVLBalancedBinarySearchTree<BinarySearchTreeType>::RotateRight(
  ...
  if (A) {
    ...
    this->root =
        C; // If B has no parent parent then B must have been the root node
...
template <class BinarySearchTreeType>
AVLBalancedBinarySearchTree<
    BinarySearchTreeType>::~AVLBalancedBinarySearchTree() {
...
template <class BinarySearchTreeType>
unsigned int BinarySearchTree<BinarySearchTreeType>::Height(
    typename BinarySearchTree::node* starting_node) {
...
template <class BinarySearchTreeType>
unsigned int BinarySearchTree<BinarySearchTreeType>::HeightRecursive(
...
template <class BinarySearchTreeType>
BinarySearchTreeType*& BinarySearchTree<BinarySearchTreeType>::GetPointerToNode(
...
BinarySearchTree<BinarySearchTreeType>::Find(
    const BinarySearchTreeType& element,
    typename BinarySearchTree<BinarySearchTreeType>::node** parent) {
...
template <class BinarySearchTreeType>
typename BinarySearchTree<BinarySearchTreeType>::node*&
BinarySearchTree<BinarySearchTreeType>::FindParent(
    const BinarySearchTreeType& element) {
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::FixTree(
    typename BinarySearchTree::node* current) {
...
BinarySearchTree<BinarySearchTreeType>::Del(
  ...
  if ((current->right) == 0 &&
      (current->left) == 0) // Leaf node, just remove it
  {
    if (parent) {
      if (direction == LEFT)
        parent->left = 0;
  ...
  } else // Go right, then as left as far as you can
  {
    ...
    current =
        current
            ->right; // Must have a right branch because the if statements above indicated that it has 2 branches
...
#pragma warning( \
    ...
    while (true) // This loop traverses the tree to find a spot for insertion
    {
      if (input < *(current->item)) {
        if (current->left == 0) {
          current->left =
              RakNet::OP_NEW<typename BinarySearchTree::node>(file, line);
          current->left->item =
              RakNet::OP_NEW<BinarySearchTreeType>(file, line);
          current = current->left;
          current->left = 0;
          current->right = 0;
          *(current->item) = input;
...
template <class BinarySearchTreeType>
bool BinarySearchTree<BinarySearchTreeType>::IsIn(
    const BinarySearchTreeType& input) {
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::DisplayInorder(
    BinarySearchTreeType* return_array) {
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::DisplayPreorder(
    BinarySearchTreeType* return_array) {
  typename BinarySearchTree::node *current, *parent;
...
template <class BinarySearchTreeType>
inline void BinarySearchTree<BinarySearchTreeType>::DisplayPostorder(
    BinarySearchTreeType* return_array) {
  unsigned int index = 0;
...
template <class BinarySearchTreeType>
void BinarySearchTree<BinarySearchTreeType>::DisplayBreadthFirstSearch(
    BinarySearchTreeType* return_array) {
  typename BinarySearchTree::node* current;
  unsigned int index = 0;
