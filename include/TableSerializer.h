...
class RAK_DLL_EXPORT TableSerializer {
 public:
  ...
  static bool DeserializeColumns(
      RakNet::BitStream* in,
      DataStructures::Table* out);
  static void SerializeRow(
