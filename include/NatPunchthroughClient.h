...
struct RAK_DLL_EXPORT PunchthroughConfiguration {
  ...
  PunchthroughConfiguration() {
    ...
    MAXIMUM_NUMBER_OF_INTERNAL_IDS_TO_CHECK =
        5; /// set to 0 to not do lan connects
...
#if _RAKNET_SUPPORT_PacketLogger == 1
/// \ingroup NAT_PUNCHTHROUGH_GROUP
struct RAK_DLL_EXPORT NatPunchthroughDebugInterface_PacketLogger
    : public NatPunchthroughDebugInterface {
