...
#define DEFINE_MULTILIST_PTR_TO_MEMBER_COMPARISONS(         \
    _CLASS_NAME_, _KEY_TYPE_, _MEMBER_VARIABLE_NAME_)       \
  bool operator<(                                           \
      const DataStructures::MLKeyRef<_KEY_TYPE_>& inputKey, \
      const _CLASS_NAME_* cls) {                            \
...
template <
    const MultilistType _MultilistType,
    class _DataType,
...
class RAK_DLL_EXPORT Multilist {
 public:
  ...
  void ForEach(
      void (*func)(_DataType& item, const char* file, unsigned int line),
      const char* file,
      unsigned int line);
  ...
  void Clear(
      bool deallocateSmallBlocks = true,
      const char* file = __FILE__,
      unsigned int line = __LINE__);
...
Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::operator=(
    const Multilist& source) {
  Clear(true);
  CopySource(source);
  return *this;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::CopySource(
    const Multilist& source) {
...
_DataType&
Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::operator[](
    const _IndexType position) const {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Push(
    const _DataType& d,
    const char* file,
    unsigned int line) {
  Push(d, d, file, line);
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Push(
  ...
  if (GetMultilistType() == ML_UNORDERED_LIST ||
      GetMultilistType() == ML_STACK || GetMultilistType() == ML_QUEUE) {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::PushOpposite(
    const _DataType& d,
    const char* file,
    unsigned int line) {
...
template <
    ...
    class _IndexType>
_DataType&
Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::PopOpposite(
    const char* file,
    unsigned int line) {
  RakAssert(IsEmpty() == false);
  if (GetMultilistType() == ML_UNORDERED_LIST ||
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::InsertAtIndex(
    const _DataType& d,
    _IndexType index,
    const char* file,
    unsigned int line) {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::RemoveAtIndex(
    _IndexType position,
    const char* file,
    unsigned int line) {
...
template <
    ...
    class _KeyType,
    class _IndexType>
bool Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::RemoveAtKey(
    _KeyType key,
    bool assertIfDoesNotExist,
    const char* file,
    unsigned int line) {
...
template <
    ...
    class _IndexType>
_IndexType
Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetIndexOf(
    _KeyType key) const {
  _IndexType i;
  if (IsSorted()) {
    bool objectExists;
    ...
    return (_IndexType)-1;
      ...
      GetMultilistType() == ML_UNORDERED_LIST ||
      GetMultilistType() == ML_STACK) {
    for (i = 0; i < dataSize; i++) {
...
template <
    ...
    class _IndexType>
_IndexType
Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetInsertionIndex(
    _KeyType key) const {
  _IndexType i;
  if (IsSorted()) {
    bool objectExists;
...
template <
    ...
    class _KeyType,
    class _IndexType>
_DataType Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::GetPtr(
    _KeyType key) const {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ForEach(
    void (*func)(_DataType& item, const char* file, unsigned int line),
    const char* file,
    unsigned int line) {
  _IndexType i;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Clear(
    bool deallocateSmallBlocks,
    const char* file,
    unsigned int line) {
  dataSize = 0;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ClearPointers(
    bool deallocateSmallBlocks,
    const char* file,
    unsigned int line) {
  _IndexType i;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ClearPointer(
    _KeyType key,
    const char* file,
    unsigned int line) {
  _IndexType i;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Reallocate(
    _IndexType size,
    const char* file,
    unsigned int line) {
  _IndexType newAllocationSize;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::Sort(
    bool force) {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::QSortAscending(
    _IndexType leftEdge,
...
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    QSortDescending(_IndexType leftEdge, _IndexType rightEdge) {
  _DataType temp;
  _IndexType left = leftEdge;
  _IndexType right = rightEdge;
  _IndexType pivotIndex = left++;
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::SetSortOrder(
    bool ascending) {
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    SetMultilistType(MultilistType newType) {
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    ReallocateIfNeeded(const char* file, unsigned int line) {
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    DeallocateIfNeeded(const char* file, unsigned int line) {
...
template <
    ...
    class _KeyType,
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::ReallocToSize(
    _IndexType newAllocationSize,
    const char* file,
    unsigned int line) {
  _DataType* newData =
      RakNet::OP_NEW_ARRAY<_DataType>(newAllocationSize, file, line);
  _IndexType i;
  for (i = 0; i < dataSize; i++)
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    InsertInOrderedList(const _DataType& d, const _KeyType& key) {
  RakAssert(GetMultilistType() == ML_ORDERED_LIST);
...
template <
    ...
    class _KeyType,
    class _IndexType>
_IndexType Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    GetIndexFromKeyInSortedList(const _KeyType& key, bool* objectExists) const {
  RakAssert(IsSorted());
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    InsertShiftArrayRight(const _DataType& d, _IndexType index) {
...
template <
    ...
    class _IndexType>
void Multilist<_MultilistType, _DataType, _KeyType, _IndexType>::
    DeleteShiftArrayLeft(_IndexType index) {
