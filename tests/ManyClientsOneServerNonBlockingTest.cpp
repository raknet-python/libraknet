...
*/
int ManyClientsOneServerNonBlockingTest::RunTest(
...
RakString ManyClientsOneServerNonBlockingTest::ErrorCodeToString(
    int errorCode) {
  switch (errorCode) {
    case 0:
      return "No error";
...
ManyClientsOneServerNonBlockingTest::~ManyClientsOneServerNonBlockingTest(
    void) = default;
